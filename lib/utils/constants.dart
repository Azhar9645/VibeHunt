...
final TextStyle jStyleW = GoogleFonts.jost(
  ...
  color: Colors.white,  // Use kWhiteColor if it's a constant defined in your code
);
...
final TextStyle j20G = GoogleFonts.jost(
  fontSize: 20,
  fontWeight: FontWeight.w500,
  color:kGreen,  // Use kWhiteColor if it's a constant defined in your code
);
...
final TextStyle jStyleHint = GoogleFonts.jost(
  fontSize: 18,
  fontWeight: FontWeight.w500,
  color: Colors.grey,  // Use kWhiteColor if it's a constant defined in your code
);